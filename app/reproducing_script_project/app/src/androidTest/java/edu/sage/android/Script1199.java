...
public class Script1199 {
    ...
    public void testChangeText_sameActivity() {
        ...
        picture = mDevice.wait(Until.findObject(By.res(BASIC_SAMPLE_PACKAGE, "btn_take_picture")),2000);
        picture.click();
        ...
        UiObject2 filter = mDevice.wait(Until.findObject(By.text("SEPIA")),2000);
        filter.click();

        filter = mDevice.wait(Until.findObject(By.text("SAVE CURRENT")),2000);
        filter.click();

        UiObject2 nav = mDevice.wait(Until.findObject(By.desc( "Navigate up")),2000);
        nav.click();
        ...
        pdf = mDevice.wait(Until.findObject(By.text( "Open File")),2000);
        pdf.click();
