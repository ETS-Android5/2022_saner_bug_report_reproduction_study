...
public class Script92 {
    ...
    public void testChangeText_sameActivity() throws IOException, UiObjectNotFoundException {
        ...
        mDevice.findObject(new UiSelector().text("Vendors")).click();
        mDevice.findObject(new UiSelector().resourceId("android:id/search_src_text")).setText("00:16:3e");
