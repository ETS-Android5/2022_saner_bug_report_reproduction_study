...
public class Script1401 {
    ...
    @Test
    public void performGUIActions() throws UiObjectNotFoundException, IOException, RemoteException {
        // Setup GUI action
        // Click "allow"
        uiDevice.findObject(new UiSelector().clickable(true).instance(1)).click();
        // Click "got it" three times
        uiDevice.findObject(new UiSelector().text("GOT IT")).click();
        uiDevice.findObject(new UiSelector().text("GOT IT")).click();
        uiDevice.findObject(new UiSelector().text("GOT IT")).click();
        // Click "camera"
        uiDevice.findObject(new UiSelector().text("Camera")).click();
        // Click "allow"
        uiDevice.findObject(new UiSelector().clickable(true).instance(1)).click();
        // Click capture
        ...
        // Click "gallery"
        uiDevice.findObject(new UiSelector().text("Gallery")).click();
        // Click photo
        ...
        // Click "sajuno"
        uiDevice.findObject(new UiSelector().text("Sajuno")).click();
        // Click tick
        uiDevice.findObject(new UiSelector().clickable(true).instance(8)).click();
        // Rotate phone
