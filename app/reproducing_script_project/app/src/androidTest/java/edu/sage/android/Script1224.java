...
public class Script1224 {
    ...
    public void performGUIActions() throws UiObjectNotFoundException, IOException, RemoteException, InterruptedException {
        ...
        // Click more on "assets"
        uiDevice.findObject(new UiSelector().className("android.widget.ImageView").instance(1)).click();
        // Click "edit account"
        uiDevice.findObject(new UiSelector().text("Edit Account")).click();
        // Click color picker
        uiDevice.findObject(new UiSelector().className("android.widget.QuickContactBadge")).click();
        // Click color 1
