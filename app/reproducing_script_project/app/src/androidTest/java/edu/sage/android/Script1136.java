...
public class Script1136 {
    ...
    public void testChangeText_sameActivity() {
        ...
        UiObject2 Note = mDevice.wait(Until.findObject(By.res(BASIC_SAMPLE_PACKAGE, "menu_view_info")), 2000);
        Note.click();
        Note = mDevice.wait(Until.findObject(By.res(BASIC_SAMPLE_PACKAGE, "info_markdown_switch")), 2000);
        Note.click();
        try {
            TimeUnit.SECONDS.sleep(1);
        } catch (InterruptedException e) {
        ...
        Note = mDevice.wait(Until.findObject(By.text( "PREVIEW")), 2000);
        Note.click();
        try {
            TimeUnit.SECONDS.sleep(2);
        } catch (InterruptedException e) {
        ...
        UiObject2 note = mDevice.wait(Until.findObject(By.res(BASIC_SAMPLE_PACKAGE, "note_title")), 2000);
        note.click();
