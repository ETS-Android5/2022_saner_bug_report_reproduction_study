...
public class Script1300 {
    ...
    public void performGUIActions() throws UiObjectNotFoundException, IOException, RemoteException, InterruptedException {
        ...
        // Click "database"
        uiDevice.findObject(new UiSelector().text("Database")).click();
        // Click "delete database"
        uiDevice.findObject(new UiSelector().text("Delete database")).click();
        // Click "yes" twice
        uiDevice.findObject(new UiSelector().clickable(true).instance(1)).click();
        uiDevice.findObject(new UiSelector().clickable(true).instance(1)).click();
        // Click back twice
        ...
        uiDevice.findObject(new UiSelector().clickable(true)).click();
        // Click "traits"
        uiDevice.findObject(new UiSelector().text("Traits")).click();
    }
