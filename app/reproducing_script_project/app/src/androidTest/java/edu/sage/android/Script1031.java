...
public class Script1031 {
    ...
    public void testChangeText_sameActivity() {
        ...
        UiObject2 advanced = mDevice.wait(Until.findObject(By.text( "Add image")),2000);
        advanced.click();

        UiObject2 camera = mDevice.wait(Until.findObject(By.text( "CAMERA")),2000);
        camera.click();
