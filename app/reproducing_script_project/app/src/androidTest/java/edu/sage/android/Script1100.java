...
public class Script1100 {
    ...
    public void testChangeText_sameActivity() {
        ...
        UiObject2 night = mDevice.wait(Until.findObject(By.text("Night mode")),2000);
        night.click();
        ...
        UiObject2 lang = mDevice.wait(Until.findObject(By.res(BASIC_SAMPLE_PACKAGE, "select_language")),2000);
        lang.click();
