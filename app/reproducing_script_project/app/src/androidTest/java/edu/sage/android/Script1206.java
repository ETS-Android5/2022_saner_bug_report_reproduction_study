...
public class Script1206 {
    ...
    public void testChangeText_sameActivity() {
        ...
        UiObject2 create = mDevice.wait(Until.findObject(By.text("Images to PDF")),2000);
        create.click();

        create = mDevice.wait(Until.findObject(By.text("SELECT IMAGES")),2000);
        create.click();

        create = mDevice.wait(Until.findObject(By.text("Camera")),2000);
        create.click();
        ...
        UiObject2 picture = mDevice.wait(Until.findObject(By.res("com.android.camera2", "shutter_button")),2000);
        picture.click();
        picture = mDevice.wait(Until.findObject(By.res("com.android.camera2", "done_button")),2000);
        picture.click();
