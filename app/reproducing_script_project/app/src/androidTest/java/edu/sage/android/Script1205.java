...
public class Script1205 {
    ...
    public void testChangeText_sameActivity() {
        ...
        mDevice.click(650,300);

        create = mDevice.wait(Until.findObject(By.text("Sure(1)")),2000);
        create.click();
        ...
        mDevice.drag(550,800, 550,500,5);
        ...
        UiObject2 cur = mDevice.wait(Until.findObject(By.text("Merge PDF")),2000);
        cur.click();
