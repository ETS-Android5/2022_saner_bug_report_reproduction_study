...
public class Script97 {
    ...
    public void testChangeText_sameActivity() throws IOException, UiObjectNotFoundException {
        ...
        mDevice.findObject(new UiSelector().text("More Samples")).click();
        mDevice.findObject(new UiSelector().text("Layouts")).click();
        mDevice.findObject(new UiSelector().text("Map in a view pager")).click();
    }
