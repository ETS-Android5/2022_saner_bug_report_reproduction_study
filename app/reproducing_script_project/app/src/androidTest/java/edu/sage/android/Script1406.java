...
public class Script1406 {
    ...
    public void performGUIActions() throws UiObjectNotFoundException, IOException {
        ...
        // Drag left
        uiDevice.swipe(1000, 1000, 0, 500, 10);
        // Click heart
        uiDevice.findObject(new UiSelector().clickable(true).instance(5)).click();
        // Click "ok"
        uiDevice.findObject(new UiSelector().text("OK")).click();
        ...
        uiDevice.findObject(new UiSelector().clickable(true)).click();
        // Click "favourites"
        uiDevice.findObject(new UiSelector().text("Favourites")).click();
        // Click photo
        uiDevice.findObject(new UiSelector().clickable(true).instance(4)).click();
        // Click edit
        uiDevice.findObject(new UiSelector().clickable(true).instance(2)).click();
        // Click "none"
        uiDevice.findObject(new UiSelector().text("None")).click();
        // Click abort
        uiDevice.findObject(new UiSelector().className("android.widget.ImageButton")).click();
        // Click "confirm"
        uiDevice.findObject(new UiSelector().text("CONFIRM")).click();
        // Click back
        uiDevice.pressBack();
        // Drag left
        uiDevice.swipe(1000, 1000, 0, 500, 10);
