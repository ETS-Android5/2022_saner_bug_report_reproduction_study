...
public class Script1316 {
    ...
    public void performGUIActions() throws UiObjectNotFoundException, IOException, RemoteException, InterruptedException {
        ...
        uiDevice.drag(500, 1700, 500, 100, 30);
        uiDevice.drag(500, 1700, 500, 100, 30);
        // Click "backup the vault"
        uiDevice.findObject(new UiSelector().text("Backup the vault")).click();
        // Click "select"
        uiDevice.findObject(new UiSelector().text("SELECT")).click();
        // Click "trigger backup"
        uiDevice.findObject(new UiSelector().text("Trigger backup")).click();
    }
