...
public class Script1146 {
    ...
    public void testChangeText_sameActivity() {
        ...
        mDevice.click(750, 125);


        UiObject2 check = mDevice.wait(Until.findObject(By.textStartsWith("NAVSTAR")),2000);
        check.click();

        close = mDevice.wait(Until.findObject(By.res("android", "button2")),2000);
        close.click();
