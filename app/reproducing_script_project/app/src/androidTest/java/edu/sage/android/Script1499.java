...
public class Script1499 {
    ...
    public void performGUIActions() throws UiObjectNotFoundException, IOException {
        ...
        // Click "dining"
        uiDevice.findObject(new UiSelector().text("Dining")).click();
        // Drag down menu
        uiDevice.swipe(500, 0, 500, 500, 10);
        uiDevice.swipe(500, 0, 500, 1000, 10);
        // Click "android"
        uiDevice.findObject(new UiSelector().text("Android")).click();
        // Turn off wifi
        uiDevice.findObject(new UiSelector().className("android.widget.Switch")).click();
        // Drag up menu
        uiDevice.swipe(500, 2000, 500, 500, 10);
        // Click dining hall
